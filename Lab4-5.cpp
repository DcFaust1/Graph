...
void Choice() {
    cout << "Введите цифру: \n" <<
            ...
            "11)Показать полустепень захода вершины\n" <<
            "12)Показать сумму стпеней всех вершин\n" <<
            "13)Показать все вершины, удалённые на n \n" <<
...
int main()
{
    ...
    while (a != 0) {
        ...
        case 12:
            ...
            break;
        case 13:
            cout << "От какой вершины? ";
            cin >> x;
            cout << "На сколько удалена? ";
            cin >> y;
